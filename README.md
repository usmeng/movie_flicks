...
* [x] Apply the popular [RxJava](https://github.com/ReactiveX/RxJava) and [Retrofit] (https://github.com/square/retrofit) to fetch data from web.
* [x] Apply rounded corners for the poster or background images using [Glide transformations](https://guides.codepath.com/android/Displaying-Images-with-the-Picasso-Library#other-transformations)
